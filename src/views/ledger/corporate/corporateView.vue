    ...
    <div class="tableChart">
      ...
      <div class="leftTabel">
        <el-table :data="leftTableData" style="width: 100%" height="235" size="mini" border>
          ...
          <el-table-column prop="limitUsed" label="授信额度已用" width="110" align="center">
            <!-- <template slot-scope="scope">
              {{ scope.row.limitUsed | NumFormat }}
            </template> -->
          </el-table-column>
          <el-table-column prop="limitAvi" label="授信额度可用" width="110" align="center">
            <!-- <template slot-scope="scope">
          ...
          <el-table-column prop="expAvi" label="敞口额度可用" width="110" align="center">
            <!-- <template slot-scope="scope">
              {{ scope.row.expAvi | NumFormat }}
            </template> -->
          </el-table-column>
          <el-table-column prop="expUsed" label="敞口额度已用" width="110" align="center">
            <!-- <template slot-scope="scope">
...
export default {
  ...
  created () {
    ...
    this.topData = JSON.parse(sessionStorage.getItem("corporateVal"))
